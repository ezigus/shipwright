...
| `scripts/sw-daemon.sh`                |  5401 | Autonomous GitHub Issue Watcher                        |
...
| `scripts/sw-status.sh`                |   605 | Dashboard showing Claude Code team status              |
...
| `scripts/sw-pipeline-test.sh`          |  1580 | E2E validation invoking the REAL pipeline       |
...
- Progress snapshots: `~/.shipwright/progress/issue-<N>.json`
- Quality findings: `.claude/pipeline-artifacts/quality-findings.json`
<!-- /AUTO:runtime-state -->
