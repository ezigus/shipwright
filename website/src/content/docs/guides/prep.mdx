...
The prep command (`shipwright prep`) analyzes your repository and generates the configuration files needed for effective agent team development. It creates `.claude/` configs, a `CLAUDE.md` file, and quality gate hooks tailored to your project.
...
shipwright prep --dry-run

# Prepare a specific directory
shipwright prep --path /path/to/project
```
