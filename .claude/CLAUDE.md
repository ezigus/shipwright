...
| `scripts/sw-daemon.sh` | 5665 | Autonomous GitHub Issue Watcher |
...
| `scripts/sw-loop.sh` | 2217 | Continuous agent loop harness for Claude Code |
...
| `scripts/sw-pipeline.sh` | 7593 | Autonomous Feature Delivery (Idea → Production) |
