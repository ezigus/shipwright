...
| `scripts/sw-loop.sh` | 3205 | Continuous agent loop harness for Claude Code |
...
| `scripts/sw-pipeline.sh` | 3903 | Autonomous Feature Delivery (Idea → Production) |
...
| `scripts/sw-ruflo-adapter-test.sh` | 4753 |  |
