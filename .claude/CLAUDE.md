...
| `scripts/sw-loop.sh`                  |  2347 | Continuous agent loop harness for Claude Code          |
...
| `scripts/sw-pipeline.sh`              |  8292 | Autonomous Feature Delivery (Idea → Production)        |
...
| `scripts/sw-strategic.sh`             |   802 | Strategic Intelligence Agent                           |
...
| `scripts/sw-loop-test.sh`              |   284 | Validate continuous agent loop harness          |
...
| `scripts/sw-strategic-test.sh`         |   202 | Validate strategic intelligence agent           |
