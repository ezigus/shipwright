...
| `scripts/sw-architecture-enforcer.sh` | 329 | Living Architecture Model & Enforcer |
...
| `scripts/sw-discovery.sh` | 615 | Cross-Pipeline Real-Time Learning |
...
| `scripts/sw-doctor.sh` | 1255 | Validate Shipwright setup |
...
| `scripts/sw-intelligence.sh` | 1564 | AI-Powered Analysis & Decision Engine |
...
| `scripts/sw-pipeline.sh` | 3259 | Autonomous Feature Delivery (Idea → Production) |
...
| `scripts/sw-triage.sh` | 822 | Intelligent Issue Labeling & Prioritization |
...
| `scripts/sw-e2e-smoke-test.sh` | 853 | Pipeline orchestration without API keys |
...
| `scripts/sw-intelligence-test.sh` | 647 | Unit tests for intelligence core |
...
| `scripts/sw-lib-loop-restart-test.sh` | 123 | Unit tests for loop state |
| `scripts/sw-lib-pipeline-detection-test.sh` | 497 | Unit tests for detection fns |
| `scripts/sw-lib-pipeline-intelligence-test.sh` | 618 | Unit tests for intelligence |
| `scripts/sw-lib-pipeline-quality-checks-test.sh` | 323 | Unit tests for quality |
| `scripts/sw-lib-pipeline-stages-test.sh` | 995 | Unit tests for stage functions |
| `scripts/sw-lib-pipeline-state-test.sh` | 578 | Unit tests for pipeline state |
...
| `scripts/sw-loop-test.sh` | 2405 | Validate continuous agent loop harness |
