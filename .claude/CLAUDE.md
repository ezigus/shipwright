...
| `scripts/sw-daemon.sh`                |  6104 | Autonomous GitHub Issue Watcher                        |
...
| `scripts/sw-intelligence.sh`          |  1202 | AI-Powered Analysis & Decision Engine                  |
...
| `scripts/sw-agi-roadmap-test.sh`           |   856 | Tests every feature we implemented                |
...
| `scripts/sw-tracker-test.sh`               |   527 | Validate tracker router, providers, and           |
