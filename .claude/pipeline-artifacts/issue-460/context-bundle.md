...
fix(prompts): exclude infra/generated files from all pipeline prompt diffs (author: ezigus, +31−25)
fix(compound-audit): source helpers.sh to satisfy _filter_gitignored_paths dependency (author: ezigus, +12−1)
fix: remove orphaned events snapshots + DoD hard stop on context overrun (author: ezigus, +450−32)
fix: stop spurious shipwright/issue-99 pushes + migrate discoveries to shipwright-data (author: ezigus, +110−13434)
