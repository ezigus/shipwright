...
| `scripts/sw-recruit.sh` | 2248 | AGI-Level Agent Recruitment & Talent Management |
...
| `scripts/sw-swarm.sh` | 620 | Dynamic agent swarm management |
...
| `scripts/sw-recruit-test.sh` | 1116 | Test suite for AGI-level agent recruitment system |
