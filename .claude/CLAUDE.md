...
| `scripts/sw-daemon.sh` | 1411 | Autonomous GitHub Issue Watcher |
...
| `scripts/sw-pipeline.sh` | 2905 | Autonomous Feature Delivery (Idea → Production) |
...
| `scripts/sw-code-review-test.sh`                 |   230 | Clean code & architecture analysis tests          |
...
| `scripts/sw-daemon-test.sh`                      |  1997 | Unit tests for daemon metrics, health, alerting   |
...
| `scripts/sw-hygiene-test.sh`                     |   219 | Repository Organization & Cleanup tests           |
| `scripts/sw-incident-test.sh`                    |   278 | Validate incident detection & response            |
| `scripts/sw-init-test.sh`                        |   657 | E2E validation of init/setup flow                 |
