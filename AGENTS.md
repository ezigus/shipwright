...
| `scripts/sw-loop.sh` | 2867 | Continuous agent loop harness for Claude Code |
...
| `scripts/sw-lib-compound-audit-test.sh` | 634 |  |
...
| `scripts/sw-loop-test.sh` | 2302 | Validate continuous agent loop harness |
