...
| `scripts/sw-cost.sh` | 1015 | Token Usage & Cost Intelligence |
...
| `scripts/sw-doctor.sh` | 1289 | Validate Shipwright setup |
...
| `scripts/sw-loop.sh` | 2946 | Continuous agent loop harness for Claude Code |
...
| `scripts/sw-pipeline.sh` | 3289 | Autonomous Feature Delivery (Idea → Production) |
...
| `scripts/sw-pipeline-test.sh` | 2334 | E2E validation invoking the REAL pipeline |
...
| `scripts/sw-ruflo-adapter-test.sh` | 3040 |  |
