...
| `scripts/sw-daemon.sh` | 5668 | Autonomous GitHub Issue Watcher |
...
| `scripts/sw-loop.sh` | 2220 | Continuous agent loop harness for Claude Code |
...
| `scripts/sw-pipeline.sh` | 7599 | Autonomous Feature Delivery (Idea → Production) |
