...
| `scripts/sw-loop.sh` | 3326 | Continuous agent loop harness for Claude Code |
...
| `scripts/sw-pipeline.sh` | 4003 | Autonomous Feature Delivery (Idea → Production) |
...
| `scripts/sw-gha-pipeline-test.sh` | 125 | Static validation of shipwright-pipeline.yml |
...
| `scripts/sw-pipeline-test.sh` | 3597 | E2E validation invoking the REAL pipeline |
