...
| `scripts/sw-loop.sh` | 3011 | Continuous agent loop harness for Claude Code |
...
| `scripts/sw-pipeline.sh` | 3664 | Autonomous Feature Delivery (Idea → Production) |
...
| `scripts/sw-lib-pipeline-stages-test.sh` | 1537 | Unit tests for stage functions |
