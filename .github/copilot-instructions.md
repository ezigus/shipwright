...
| `scripts/sw-loop.sh` | 2590 | Continuous agent loop harness for Claude Code |
...
| `scripts/sw-pipeline.sh` | 3196 | Autonomous Feature Delivery (Idea → Production) |
...
| `scripts/sw-lib-pipeline-state-test.sh` | 457 | Unit tests for pipeline state |
...
| `scripts/sw-loop-test.sh` | 1557 | Validate continuous agent loop harness |
