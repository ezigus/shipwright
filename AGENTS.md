...
| `scripts/sw-discovery.sh` | 609 | Cross-Pipeline Real-Time Learning |
...
| `scripts/sw-loop-test.sh` | 2222 | Validate continuous agent loop harness |
...
| `scripts/sw-pipeline-test.sh` | 2010 | E2E validation invoking the REAL pipeline |
...
| `scripts/sw-ruflo-adapter-test.sh` | 1022 |  |
